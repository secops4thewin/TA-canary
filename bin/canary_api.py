...
'''
    ...
    Add your modular input logic to file input_module_canary_api.py
'''
class ModInputcanary_api(modinput_wrapper.base_modinput.BaseModInput):
...
if __name__ == "__main__":
    exitcode = ModInputcanary_api().run(sys.argv)
    sys.exit(exitcode)
